...
Original file is located at
    https://colab.research.google.com/drive/1UHcMKiaY4WkO1Kk8szhkaDqsargR_KHR
...
fig.update_layout(
    ...
    annotations=[dict(text='Gender', x=0.16, y=0.5, font_size=20, showarrow=False),dict(text='Churn', x=0.84, y=0.5, font_size=20, showarrow=False)])
fig.show()
...
There are total 1401+148=1549 actual non-churn values and the algorithm predicts 1400 of them as non churn and 148 of them as churn.
While there are 240+321=561 actual churn values and the algorithm predicts 237 of them as non churn values and 321 of them as churn values.
